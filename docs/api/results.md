...
*\* PUT without auth may intermittently pass due to known Restful-Booker behavior*
*\*\* API accepts invalid types due to weak validation (documented as known bugs)*
*\*\*\* Rate limiting not implemented (no 429 responses)*
